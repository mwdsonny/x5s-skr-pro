...
#define STRING_CONFIG_H_AUTHOR "Mark W. Dandridge, Jr." // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "TronXY X5S" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "SKR PRO V1"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Joe"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 162.4, 161.2, 808, 843.2
 }
